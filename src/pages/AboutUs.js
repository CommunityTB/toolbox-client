    ...
    return (
      <div className="divaboutUs">
        <article className="divaboutUs">
          ...
          <p>Our tools list online does not include the blades or bits but we have them here for purchase or to borrow. Our team will gladly assist you in finding the right components to help you finish your projects. Welcome to our community!</p>
        </article>


        <article>
          <h2 className="sectionTitle">How it Works</h2>
          <h3 className="HowItworksTitle">I've picked tools-now what?</h3>
          ...
          <ul className="stepsList">
            <li>1) Bring your ID (state ID, passport, photo id work badge)</li>
            <li>2) Bring cash or debit/credit card to join if you aren't already a member of the co-op (if planning on sliding scale or volunteer hours please bring proof of income in the form of two recent paystubs or direct deposit proof of income.)</li>
            <li>3) Go through safety checklist with staff member</li>
            <li>4) Checkout your tool(s) and get to work!</li>
          </ul>
        </article>
      </div>
    );
