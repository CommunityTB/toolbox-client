      ...
      <div className="divaboutUs">
        <div className="text-wrapper">
          ...
          <article className="about-text">
            ...
            <p className="paragraph-text">As a group of neighbors we decided to pool our resources to invest in some tools to share as we did home improvement projects like patios, landscaping, repairs, and the like. No single family wanted to spend the money for a tool they might use only once or twice. Storage space was be an issue for some. Rental fees at the big box stores were also cost prohibitive for many.</p>
            <p className="paragraph-text">This group of neighbors became the co-op we have today. Our tools are now purchased by the co-op and maintained by our volunteers. We welcome you to browse our tool selection and if we have what you need, register with us, and rent our tools. We'll ask you to join the co-op with a yearly fee (income based sliding scale or $100.00/yr), and you can borrow as many tools throughout the year as you need. We simply ask that you maintain the tools you borrow and return or renew them promptly. For those that money is still an issue, become one of our shop vollunteers. Pay your deposit by reviewing tool safety with renters, helping with basic repairs of tools, helping with paperwork, or shopping for replacements.</p>
            <p className="paragraph-text">Our tools list online does not include blades or bits, but we have them here for purchase or to borrow. Our team will gladly assist you in finding the right components to help you finish your projects. Welcome to our community!</p>
          </article>
